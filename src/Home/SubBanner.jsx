  ...
  return (
    <div>
        ...
        <div className='wrapper'>
            <main className='container mx-auto z-3 pt-40 px-2 md:flex items-center shadow-sm'>
                <div>
                    ...
                    <div className="banner-btns ">
                        ...
                        <button><CgArrowLongRight className="arrow md:text-3xl text-2xl text-red-700" /></button>
                    </div>
                </div>
